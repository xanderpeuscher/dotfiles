...
class VersionChecker(object):
  ...
  def _NewVersionExists(self):
    ...
    Returns: A tuple with two elements. First indicates whether a new gcutil
        version exists, the second contains the lastest known version.
    """
  ...
  def CheckForNewVersion(self):
    ...
    try:
      newer_exists, latest_version = self._NewVersionExists()
      if newer_exists:
        LOGGER.warning(
